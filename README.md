...
- Diploma in Data Analysis — SIS 
  Specialized in Excel, Power BI, SQL,Python, and practical data project experience.
  
- Diploma in Busniess Inteligence — Udemy
  Gained practical knowledge in data analysis, reporting, and business intelligence tools to transform raw data into actionable insights for decision-making.

- Bachelor of Computer Science (Artificial Intelligence) — Beni Suef National University  
  Strong foundation in programming, data algorithms, and AI principles supporting analytical work.

---

## Skills
### Technical Skills:
- **Data Analysis Tools:** Microsoft Excel (pivot tables, formulas), Power BI (data modeling, DAX)
- **Programming & Databases:** Python (pandas for data manipulation), SQL Server (queries, database management)
- **Data Processing:** Data cleaning, transformation, and automation techniques
- **Reporting & Visualization:** Creating clear, insightful dashboards and reports for diverse audiences
- **Web Scrapping** Collecting and extracting data from websites using automated tools and scripts to support data analysis and research.
- **KPI Tracking & Analysis** Monitoring key performance indicators to evaluate performance, identify trends, and support data-driven decision-making.
